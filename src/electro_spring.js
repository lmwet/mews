...
export default function ElectroSpring() {
    ...
    const artists = [
        ...
        {
            name: "deena",
            engTitle: "Deena Abdelwahed",
            arabicTitle: "دينا عبد الواحد",
            imgUrl: "/images/deena.jpg",
            get: "/deena.json",
            web: "https://www.facebook.com/deenaabdelwahedfeed/",
        },
        {
            name: "yasmine",
        ...
        },
        {
            ...
            get: "/maii.json",
            web: "https://www.facebook.com/maii.w.yassin",
        },
        {
            name: "nawel",
